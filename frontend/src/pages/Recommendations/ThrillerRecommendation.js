...
const ThrillerRecommendation = () => {
    ...
    useEffect(() => {
        console.log("🕵️ ThrillerRecommendation: useEffect triggered");
        ...
        const fetchRecommendation = async () => {
            try {
                ...
                console.log("🎬 Thriller - Data received from backend:", data);
                ...
                console.error("❌ Thriller - Error during fetch:", err);
    ...
    return (
        <div style={styles.container}>
            <h1>🕵️ Your Thriller Movie Recommendation</h1>
...
export default ThrillerRecommendation;

...
const SportRecommendation = () => {
    ...
    useEffect(() => {
        console.log("🏅 SportRecommendation: useEffect triggered");
        ...
        const fetchRecommendation = async () => {
            try {
                ...
                console.log("🏆 Sports - Data received from backend:", data);
                ...
                console.error("❌ Sports - Error during fetch:", err);
    ...
    return (
        <div style={styles.container}>
            <h1>⚽ Your Sports Movie Recommendation</h1>

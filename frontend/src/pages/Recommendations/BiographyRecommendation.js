...
const BiographyRecommendation = () => {
    ...
    useEffect(() => {
        console.log("📖 BiographyRecommendation: useEffect triggered");
    ...
    return (
        <div style={styles.container}>
            <h1>🎥 Your Biography Movie Recommendation</h1>
...
export default BiographyRecommendation;

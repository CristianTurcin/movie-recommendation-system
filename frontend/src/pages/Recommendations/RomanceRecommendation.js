...
const RomanceRecommendation = () => {
    ...
    useEffect(() => {
        console.log("💖 RomanceRecommendation: useEffect triggered");
        ...
        const fetchRecommendation = async () => {
            try {
                ...
                console.error("❌ Romance - Error during fetch:", err);
    ...
    return (
        <div style={styles.container}>
            <h1>🎬 Your Romantic Movie Recommendation</h1>
...
export default RomanceRecommendation;

...
const SciFiRecommendation = () => {
    ...
    useEffect(() => {
        console.log("🛸 SciFiRecommendation: useEffect triggered");
        ...
        const fetchRecommendation = async () => {
            try {
                ...
                console.log("👽 Sci-Fi - Data received from backend:", data);
                ...
                console.error("❌ Sci-Fi - Error during fetch:", err);
    ...
    return (
        <div style={styles.container}>
            <h1>👽 Your Sci-Fi Movie Recommendation</h1>
...
export default SciFiRecommendation;
